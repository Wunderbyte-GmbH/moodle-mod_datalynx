 ...
 *********************************************************************************/
    ...
    public static function get_custom_user_fields($entries) {
        global $CFG, $DB;
        require_once('fieldtransfer_client.php');
        ...
        foreach ($hostidtousers as $hostid => $usernames) {
            ...
            $userdata = fieldtransfer_request_user_info($url, $usernames, $fieldnames);
