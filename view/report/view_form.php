    ...
    public function view_definition_after_gps(): void {
        ...
        if (!empty($fieldnames)) {
            ...
            $mform->addElement(
                'autocomplete',
                'param1',
                get_string('fieldtobecounted', 'datalynxview_report'),
                $fieldnames,
                $options
            );
            ...
            $mform->addElement(
                'static',
                'noselectfields',
                get_string('selectfield', 'datalynxview_report'),
        ...
        if (!empty($fields)) {
            ...
            $mform->addElement(
                'select',
                'param4',
                get_string('groupbyfield', 'datalynxview_report'),
                $fieldnames,
                $options
            );
        ...
        $mform->addElement(
            'select',
            'param2',
            get_string('sumfield', 'datalynxview_report'),
            $fieldnames,
            $options
        );
