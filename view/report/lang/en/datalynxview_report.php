 ...
 */
$string['customsql'] = 'The SQL query for the report';
$string['customsql_help'] = 'Write the SQL query for the report. You can use placeholders for fields.';
$string['entriesovertime'] = 'Entries over time';
$string['exportfields'] = 'Fields to be used in the report';
$string['exportfields_help'] = 'Add fields that will be used in the report: [[fieldname]] and separate by line.';
$string['fieldtobecounted'] = 'Field to be counted';
...
$string['optiondistribution'] = 'Option distribution';
$string['pluginname'] = 'Report';
$string['privacy:metadata'] = 'The Report View does not store personal data.';
$string['report'] = 'Report';
$string['reporttype'] = 'Report type';
$string['scopefield'] = 'Date field';
$string['scopefrom'] = 'From';
$string['scopemode'] = 'Period';
$string['scopemode_all'] = 'All entries';
$string['scopemode_month'] = 'Month';
$string['scopemode_range'] = 'Custom range';
$string['scopemode_year'] = 'Year';
$string['scopeto'] = 'To';
...
$string['usertotals'] = 'Entries per user';
$string['xls'] = 'Excel';
