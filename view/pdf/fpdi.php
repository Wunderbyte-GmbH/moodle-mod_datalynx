 ...
 * Based on assignfeedback_editpdf to integrate fpdi for pdf merging.
 *
 * @package datalynxview
 * @subpackage pdf
 * @copyright 2019 onwards edulabs.org and associated programmers
 * @copyright based on the work by 2012 Davo Smith
