...
$string['destd'] = 'Send to download';
$string['destf'] = 'Save to server file';
$string['destfd'] = 'Save to server file and send to browser and force download';
$string['destfi'] = 'Save to server file and send to browser';
$string['desti'] = 'Send to browser';
...
$string['permannot-forms'] = 'Manage annotations and forms';
$string['permassemble'] = 'Assemble';
$string['permcopy'] = 'Copy/extract content';
$string['permextract'] = 'Extract content';
$string['permfill-forms'] = 'Fill in forms';
$string['permmodify'] = 'Modify content';
$string['permowner'] = 'Manage protection (inverted logic - only for public-key)';
$string['permprint'] = 'Print the document';
$string['permprint-high'] = 'Print high level';
...
$string['unit'] = 'Unit';
$string['unitcm'] = 'Centimeter';
$string['unitin'] = 'Inch';
$string['unitmm'] = 'Millimeter';
$string['unitpt'] = 'Point';
