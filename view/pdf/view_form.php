...
class datalynxview_pdf_form extends datalynxview_base_form {
    ...
    function view_definition_after_gps() {
        ...
        // PDF settings (param1)
        //-------------------------------------------------------------------------------
        $mform->addElement('header', 'pdfsettingshdr', get_string('pdfsettings', 'datalynxview_pdf'));
        // Document name
        $mform->addElement('text', 'docname', get_string('docname', 'datalynxview_pdf'), array('size' => 64));
        $mform->setType('docname', PARAM_TEXT);
        $mform->addHelpButton('docname', 'docname', 'datalynxview_pdf');
        // Orientation: Portrait, Landscape
        $options = array(
            '' => get_string('auto', 'datalynxview_pdf'),
            'P' => get_string('portrait', 'datalynxview_pdf'),
            'L' => get_string('landscape', 'datalynxview_pdf'),
        );
        $mform->addElement('select', 'orientation', get_string('orientation', 'datalynxview_pdf'), $options);
        // Unit
        $options = array(
            'mm' => get_string('unit_mm', 'datalynxview_pdf'),
        ...
        // Format
        $options = array(
            'A4' => get_string('A4', 'datalynxview_pdf'),
            'LETTER' => get_string('LETTER', 'datalynxview_pdf'),
        );
        $mform->addElement('select', 'format', get_string('format', 'datalynxview_pdf'), $options);
        // Destination
        $options = array(
            'D' => get_string('dest_D', 'datalynxview_pdf'),
            'I' => get_string('dest_I', 'datalynxview_pdf'),
            //'F' => get_string('dest_F', 'datalynxview_pdf'),
            //'FI' => get_string('dest_FI', 'datalynxview_pdf'),
            //'FD' => get_string('dest_FD', 'datalynxview_pdf'),
        );
        $mform->addElement('select', 'destination', get_string('destination', 'datalynxview_pdf'), $options);
        ...
        // Title
        $mform->addElement('textarea', 'toctitle', get_string('toctitle', 'datalynxview_pdf'), array('rows' => 3, 'style' => 'width:100%'));
        $mform->addHelpButton('toctitle', 'toctitle', 'datalynxview_pdf');
        // Template
        $mform->addElement('textarea', 'toctmpl', get_string('toctmpl', 'datalynxview_pdf'), array('rows' => 10, 'style' => 'width:100%'));
        ...
        $mform->addElement('filemanager', 'pdfframe', get_string('image', 'datalynxview_pdf'), null, $fileoptions);
        ...
        $fileoptions = array('subdirs' => 0, 'maxbytes' => -1, 'maxfiles' => 1, 'accepted_types' => array('image'));
        // Watermark image
        $mform->addElement('filemanager', 'pdfwmark', get_string('image', 'datalynxview_pdf'), null, $fileoptions);
        ...
        $mform->addElement('select', 'transparency', get_string('transparency', 'datalynxview_pdf'), $options);
        ...
        // Header enbabled
        $mform->addElement('selectyesno', 'headerenabled', get_string('enabled', 'datalynxview_pdf'));
        ...
        // Header margin top
        $mform->addElement('text', 'headermargintop', get_string('margin', 'datalynxview_pdf'). ' '. get_string('margintop', 'datalynxview_pdf'));
        ...
        // Header margin left
        $mform->addElement('text', 'headermarginleft', get_string('margin', 'datalynxview_pdf'). ' '. get_string('marginleft', 'datalynxview_pdf'));
        ...
        // Footer enbabled
        $mform->addElement('selectyesno', 'footerenabled', get_string('enabled', 'datalynxview_pdf'));
        ...
        $mform->addElement('select', 'footermargin', get_string('margin', 'datalynxview_pdf'), $options);
        ...
        // Protection
        //-------------------------------------------------------------------------------
        $mform->addElement('header', 'pdfprotectionhdr', get_string('pdfprotection', 'datalynxview_pdf'));
        ...
        $mform->addGroup($elemgrp, "perms_grp", get_string('protperms', 'datalynxview_pdf'), '<br />', false);
        ...
        $mform->addElement('select', 'protmode', get_string('protmode', 'datalynxview_pdf'), $options);
        ...
        // Digital Signature
        //-------------------------------------------------------------------------------
        $mform->addElement('header', 'pdfsignaturehdr', get_string('pdfsignature', 'datalynxview_pdf'));

        // Certification
        $fileoptions = array('subdirs' => 0, 'maxbytes' => -1, 'maxfiles' => 1, 'accepted_types' => array('.crt'));
        $mform->addElement('filemanager', 'pdfcert', get_string('certification', 'datalynxview_pdf'), null, $fileoptions);
        ...
        $options = array(
            1 => get_string('none'),
            2 => get_string('certperm2', 'datalynxview_pdf'),
            3 => get_string('certperm3', 'datalynxview_pdf'),
        );
        $mform->addElement('select', 'certtype', get_string('certtype', 'datalynxview_pdf'), $options);
        ...
        $mform->addElement('text', 'certinforeason', get_string('certinforeason', 'datalynxview_pdf'));
        $mform->setType('certinforeason', PARAM_TEXT);

        $mform->addElement('text', 'certinfocontact', get_string('certinfocontact', 'datalynxview_pdf'));
