...
class view extends base {
    ...
    public function generate_default_view() {
        ...
        $this->view->esection = $this->get_default_esection_html('tabular', '##addnewentry##');
    ...
    public function display(array $options = []): string {
        ...
        $output = parent::display(array_merge($options, [
            ...
            'entriesplaceholder' => $browsemode
                ? $this->render_view_browser_region('mod-datalynx-tabular-entries', 'tabular-view-browser')
                : null,
        ]));
