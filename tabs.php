...
if (isloggedin() && $istemplatemanager) {
    ...
    $row[] = new tabobject('browse',
            new moodle_url('/mod/datalynx/view.php', ['d' => $this->id()]), get_string('browse', 'datalynx'));
    $row[] = new tabobject('manage',
            new moodle_url('/mod/datalynx/view/index.php', ['d' => $this->id()]), get_string('manage', 'datalynx'));
    // Add view edit tab.
