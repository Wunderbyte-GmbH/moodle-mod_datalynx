...
use mod_datalynx\output\tabular_view_browser;
...
/**
 * Web service to fetch structured Tabular view browse data.
 *
 * @package    mod_datalynx
 * @copyright  2026 David Bogner
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class get_tabular_view_data extends external_api {
    /**
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'view' => new external_value(PARAM_INT, 'Tabular view ID'),
    ...
    /**
     * Return structured browse data for one Tabular view page.
     *
     * @param int $d
     * @param int $view
     * @param int $filterid
    ...
    public static function execute(
        ...
        $renderable = new tabular_view_browser($payload);
                ...
                new external_single_structure([
                    ...
                    'columns' => new external_multiple_structure(
                        new external_single_structure([
                            ...
                            'alignclass' => new external_value(PARAM_RAW, 'Header and cell alignment class'),
                            'alignstyle' => new external_value(PARAM_ALPHA, 'Header alignment style'),
                            'columnclass' => new external_value(PARAM_TEXT, 'Legacy column class name'),
                            'islast' => new external_value(PARAM_BOOL, 'Whether this is the last column'),
                        ])
                    ),
                    'rows' => new external_multiple_structure(
                        new external_single_structure([
                            'id' => new external_value(PARAM_INT, 'Entry ID'),
                            'rowclass' => new external_value(PARAM_TEXT, 'Legacy row class name'),
                            'cells' => new external_multiple_structure(
                                new external_single_structure([
                                    'valuehtml' => new external_value(PARAM_RAW, 'Rendered cell HTML'),
                                    'alignclass' => new external_value(PARAM_RAW, 'Cell alignment class'),
                                    'alignstyle' => new external_value(PARAM_ALPHA, 'Cell alignment style'),
                                    'columnclass' => new external_value(PARAM_TEXT, 'Legacy column class name'),
                                    'islast' => new external_value(PARAM_BOOL, 'Whether this is the last column'),
                                ])
                            ),
