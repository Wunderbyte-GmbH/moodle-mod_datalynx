...
/**
 * The mod_datalynx entry disapproved event.
 *
...
/**
 * The mod_datalynx entry disapproved event class.
 *
...
class entry_disapproved extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' disapproved the datalynx entry with id '$this->objectid' for the datalynx activity " .
    ...
    public function get_url() {
        return new \moodle_url('/mod/datalynx/view.php', array('d' => $this->other['dataid'], 'rid' => $this->objectid));
    }
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'datalynx', 'entry_disapproved', 'view.php?d=' . $this->other['dataid'] . '&amp;eid=' . $this->objectid,
