 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class filter_deleted extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the datalynx filter with id '$this->objectid' for the datalynx activity " .
