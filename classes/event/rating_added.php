...
/**
 * The mod_datalynx rating added event.
 *
...
/**
 * The mod_datalynx rating added event class.
 *
...
class rating_added extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' added the datalynx rating with id '$this->objectid' for the datalynx activity " .
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'datalynx', 'rating_added', 'view.php?d=' . $this->other['dataid'] . '&amp;eid=' . $this->objectid,
