...
class css_saved extends \core\event\base {
    ...
    public function get_url() {
        return new \moodle_url('/mod/datalynx/view.php', array('d' => $this->objectid, 'cssedit' => 1));
    }
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'datalynx', 'css_saved', 'view.php?d=' . $this->objectid . '&cssedit=1',
