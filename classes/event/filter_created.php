 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class filter_created extends \core\event\base {
    ...
    protected function init() {
        $this->data['objecttable'] = 'datalynx_filters';
        $this->data['crud'] = 'c';
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the datalynx filter with id '$this->objectid' for the datalynx activity " .
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'datalynx', 'filter_created', 'view.php?d=' . $this->other['dataid'],
