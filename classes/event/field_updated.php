...
class field_updated extends \core\event\base {
    ...
    public function get_url() {
        return new \moodle_url('/mod/datalynx/field.php', array('d' => $this->other['dataid'], 'vid' => $this->objectid));
    }
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'datalynx', 'field_updated', 'view.php?d=' . $this->other['dataid'],
