...
class field_deleted extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the datalynx field with id '$this->objectid' for the datalynx activity " .
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'datalynx', 'field_created', 'view.php?d=' . $this->other['dataid'],
