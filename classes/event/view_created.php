 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class view_created extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the datalynx view with id '$this->objectid' for the datalynx activity " .
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'datalynx', 'view_created', 'view.php?d=' . $this->other['dataid'] . '&amp;vid=' . $this->objectid,
