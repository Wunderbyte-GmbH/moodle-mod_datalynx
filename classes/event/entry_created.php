...
/**
 * The mod_datalynx entry created event class.
 *
...
class entry_created extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the datalynx entry with id '$this->objectid' for the datalynx activity " .
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'datalynx', 'entry_created', 'view.php?d=' . $this->other['dataid'] . '&amp;eid=' . $this->objectid,
