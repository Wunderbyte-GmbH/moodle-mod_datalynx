...
class rating_updated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the datalynx rating with id '$this->objectid' for the datalynx activity " .
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'datalynx', 'rating_updated', 'view.php?d=' . $this->other['dataid'] . '&amp;eid=' . $this->objectid,
