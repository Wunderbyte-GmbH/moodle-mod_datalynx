...
abstract class datalynxfield_renderer {
     ...
     *
     * Option labels are authored text (the lines of a field's param1), so they must be filtered
     * before they are shown, otherwise filter markup such as multilang2's {mlang ...} appears raw.
     * Entry HTML is emitted directly rather than passed through format_text() again, so this is
     * the only place the labels get filtered.
     *
