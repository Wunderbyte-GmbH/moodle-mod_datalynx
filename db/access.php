...
$capabilities = array(
    ...
    'mod/datalynx:addinstance' => array('riskbitmask' => RISK_XSS, 
...
'guest' => CAP_ALLOW, 'user' => CAP_ALLOW, 'student' => CAP_ALLOW, 'teacher' => CAP_ALLOW, 
    ...
    'riskbitmask' => RISK_PERSONAL, RISK_DATALOSS, 'captype' => 'write', 
        'contextlevel' => CONTEXT_MODULE, 'archetypes' => array()
    ), 
    ...
    'riskbitmask' => RISK_PERSONAL, 'captype' => 'write', 'contextlevel' => CONTEXT_MODULE, 
        'archetypes' => array('manager' => CAP_ALLOW, 'teacher' => CAP_ALLOW, 
            'editingteacher' => CAP_ALLOW, 'student' => CAP_ALLOW
        )
    )
