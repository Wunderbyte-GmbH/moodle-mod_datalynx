...
namespace datalynxfield_picture\form;

/**
 * Form class for picture field formats.
 *
...
class field_format_form extends \mod_datalynx\form\field_format_base_form {
    /**
     * Define the specific elements for the picture format.
     */
    protected function format_definition() {
        ...
        $modes = [
            '' => get_string('default'),
            'thumb' => 'Thumbnail',
            'linked' => 'Linked full image',
            'linked_thumb' => 'Linked thumbnail',
            'lightbox' => 'Lightbox',
            'alt' => 'Alt text only',
