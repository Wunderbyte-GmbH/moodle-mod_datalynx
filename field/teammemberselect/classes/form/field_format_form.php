...
namespace datalynxfield_teammemberselect\form;

/**
 * Form class for teammemberselect field formats.
 *
...
class field_format_form extends \mod_datalynx\form\field_format_base_form {
    /**
     * Define the specific elements for the teammemberselect format.
     */
