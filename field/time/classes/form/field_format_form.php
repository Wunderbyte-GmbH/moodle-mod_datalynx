...
namespace datalynxfield_time\form;

/**
 * Form class for time field formats.
 *
...
class field_format_form extends \mod_datalynx\form\field_format_base_form {
    /**
     * Define the specific elements for the time format.
     */
    protected function format_definition() {
        $mform = &$this->_form;
        $mform->addElement('text', 'dateformat', get_string('dateformat', 'datalynxfield_time'));
