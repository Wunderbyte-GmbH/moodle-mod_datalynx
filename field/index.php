...
// any notifications
if (!$fields = $df->get_user_defined_fields(true, flexible_table::get_sort_for_table('datalynxfieldsindex'. $df->id()))) {
    $df->notifications['bad'][] = get_string('fieldnoneindatalynx','datalynx');  // nothing in datalynx
}
...
$popupurl = new moodle_url('/mod/datalynx/field/field_edit.php', array('d' => $df->id(), 'sesskey' => sesskey()));
