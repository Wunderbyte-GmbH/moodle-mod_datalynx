...
$fieldselect = new single_select($popupurl, 'type', $menufield, null, array('' => 'choosedots'
), 'fieldform');
...
if ($fields) {
    ...
    foreach ($fields as $fieldid => $field) {
        ...
        $fieldvisible = html_writer::link(
                new moodle_url($actionbaseurl, $linkparams + array('visible' => $fieldid
                )), $visibleicon);
        ...
        $fieldeditable = html_writer::link(
                new moodle_url($actionbaseurl, $linkparams + array('editable' => $fieldid
                )), $editableicon);
        ...
        if ($field->type == "textarea") {
            ...
            $convert = html_writer::link(
                    new moodle_url($actionbaseurl, $linkparams + array('convert' => $fieldid
                    )), $converticon);
        } else {
            $convert = '';
        }
