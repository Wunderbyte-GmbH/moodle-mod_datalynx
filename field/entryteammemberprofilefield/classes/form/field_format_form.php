...
namespace datalynxfield_entryteammemberprofilefield\form;

/**
 * Form class for entryteammemberprofilefield field formats.
 *
...
class field_format_form extends \mod_datalynx\form\field_format_base_form {
    /**
     * Define the specific elements for the entryteammemberprofilefield format.
     */
