...
class datalynx_rating_manager extends rating_manager {
     ...
     *        items => array an array of items such as forum posts or glossary items. They must have
     *        an 'id' member ie $items[0]->id[required]
     ...
     *        returnurl => string the url to return the user to after submitting a rating. Can be
     *        left null for ajax requests [optional]
     *        assesstimestart => int only allow rating of items created after this timestamp
     *        [optional]
     *        assesstimefinish => int only allow rating of items created before this timestamp
     *        [optional]
