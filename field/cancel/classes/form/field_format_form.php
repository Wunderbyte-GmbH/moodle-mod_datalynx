...
namespace datalynxfield_cancel\form;

/**
 * Form class for cancel field formats.
 *
...
class field_format_form extends \mod_datalynx\form\field_format_base_form {
    /**
     * Define the specific elements for the cancel format.
     */
    protected function format_definition() {
        $mform = &$this->_form;
        $mform->addElement('text', 'buttontext', get_string('buttontext', 'datalynxfield_cancel'));
        $mform->setType('buttontext', PARAM_TEXT);
        $mform->addElement('text', 'cssclasses', get_string('cssclasses', 'datalynxfield_cancel'));
