...
$string['privacy:metadata:datalynx_waypoints:timeplanned'] = 'Planned time at one stop.';
...
$string['requiretimes'] = 'Require a time for every stop';
$string['requiretimes_help'] = 'Times let matching rule out journeys that overlap geographically but not in time.';
