...
$string['upcomingreleaseannouncement'] = 'Am 1. November 2026 erscheint eine neue Hauptversion von Datalynx mit umfangreichen Änderungen. Bitte <a href="{$a->downloadurl}" target="_blank" rel="noopener noreferrer">laden Sie sie herunter und testen Sie sie</a> vorab auf einem Staging- oder Testsystem. Sobald Sie dies zur Kenntnis genommen haben, können Sie diesen Hinweis in <a href="{$a->settingsurl}">den Datalynx-Einstellungen</a> ausblenden.';
$string['upcomingreleasedismissed'] = 'Ich habe dies gelesen und benötige die Erinnerung nicht mehr';
$string['upcomingreleasedismissed_desc'] = 'Dieses Kästchen blendet nur die Erinnerung oben und auf den Datalynx-Aktivitätsseiten aus – es installiert nichts, meldet diese Website nicht von der neuen Version ab und ändert nichts am Erscheinungstermin 1. November 2026. Lassen Sie es deaktiviert, bis Sie die kommende Version heruntergeladen und getestet haben; aktivieren Sie es erst, nachdem Sie die Ankündigung zur Kenntnis genommen haben, damit die Erinnerung nicht mehr erscheint.';
$string['upcomingreleasehdr'] = '⚠️ Kommende Hauptversion – 1. November 2026';
$string['upcomingreleasehdr_desc'] = 'Am 1. November 2026 erscheint eine neue Hauptversion von Datalynx mit umfangreichen, nicht abwärtskompatiblen Änderungen.<br /><br />Diese Version installiert sich <strong>nicht von selbst</strong>: An diesem Datum ändert sich auf dieser Website automatisch nichts. Die neue Version wird lediglich im Quell-Repository des Plugins verfügbar sein – wer auch immer diesen Server betreut, muss sie manuell einspielen, genau wie jedes andere Update.<br /><br />Da die Änderungen umfangreich sind, laden Sie die kommende Version bitte vorab <a href="{$a->downloadurl}" target="_blank" rel="noopener noreferrer">herunter und testen Sie sie</a> auf einem Staging- oder Testsystem, bevor Sie sie hier installieren.<br /><br />Bis das Kästchen unten aktiviert wird, erscheint dieser Hinweis auf jeder Datalynx-Aktivitätsseite – aber nur für Website-Administrator:innen; andere Nutzer:innen sehen ihn nie, und er blockiert die Seite zu keinem Zeitpunkt.';
