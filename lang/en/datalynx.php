...
$string['upcomingreleasedismissed'] = "I've noted the upcoming release announcement";
$string['upcomingreleasedismissed_desc'] = 'Hides the upcoming-release announcement shown to site administrators on Datalynx view pages.';
$string['upcomingreleasehdr'] = 'Upcoming major release';
$string['upcomingreleasehdr_desc'] = 'On 1 October 2026 a major new version of Datalynx will be released with extensive changes. We recommend downloading and testing it on a staging or test site beforehand.';
