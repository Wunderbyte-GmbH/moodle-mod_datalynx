...
$string['after'] = 'after';
$string['ajaxviewloaderror'] = 'Unable to load the view entries.';
$string['ajaxviewloading'] = 'Loading entries...';
...
$string['approvalstateapproved'] = 'Approved';
$string['approvalstatenotapproved'] = 'Not approved';
...
$string['behavioreditmodaltitle'] = 'Behavior settings';
...
$string['choosestyle'] = 'Choose a style';
...
$string['confirmlayoutdelete'] = 'You are about to delete this field layout!';
$string['confirmlayoutduplicate'] = 'You are about to duplicate this field layout!';
...
$string['cssincludesinvalid'] = 'The "Include external CSS" field must contain one stylesheet URL or path per line, not CSS code. Lines containing spaces, braces ({ }) or semicolons look like CSS source code and are not allowed here. Put your CSS rules into the "CSS code" field instead.';
...
$string['datalynx:editprivilegestudent'] = 'Edit privilege level: Student';
$string['datalynx:editprivilegeteacher'] = 'Edit privilege level: Teacher (non-editing teacher and editing teacher)';
...
$string['datalynx:viewprivilegeadmin'] = 'View privilege level: Administrator (no default role assignment)';
$string['datalynx:viewprivilegeguest'] = 'View privilege level: Guest and authenticated users';
$string['datalynx:viewprivilegemanager'] = 'View privilege level: Manager';
$string['datalynx:viewprivilegestudent'] = 'View privilege level: Student';
$string['datalynx:viewprivilegeteacher'] = 'View privilege level: Teacher (non-editing teacher and editing teacher)';
...
$string['datalynxcsssaved'] = 'Custom CSS saved';
...
$string['datalynxjssaved'] = 'Custom JavaScript saved';
...
$string['datalynxteamupdated'] = 'Team updated';
$string['defaultbehavior'] = 'Default behavior';
$string['defaultfilterlabel'] = 'Default filter ({$a})';
$string['defaultformat'] = 'Default (no format)';
$string['defaultlayout'] = 'Default layout';
$string['defaultview'] = 'D';
$string['deleteentryid'] = 'Delete Entryid {$a}';
$string['deletefieldconfirmmsg'] = 'Delete field and remove the field tag from these views?';
$string['deletefieldconfirmmsg_multiple'] = 'Delete fields and remove their field tags from these views?';
$string['deletefieldconfirmmsg_multiple_usedin'] = 'Delete fields and remove their field tags from these views?<br><br><strong>Used in views:</strong><br>{$a}';
$string['deletefieldconfirmmsg_usedin'] = 'Delete field and remove the field tag from these views?<br><br><strong>Used in views:</strong><br>{$a}';
$string['deletefieldconfirmtitle'] = 'Delete field';
$string['deletefieldcustomfilterwarning'] = 'Warning! You are attempting to delete the following fields:{$a->fieldlist}However, the custom filter(s) listed below are still using some of these fields:{$a->customfilterlist}You must remove these fields from the custom filters first before you may proceed.';
...
$string['deletefieldgroupwarning'] = 'Warning! You are attempting to delete the following fields:{$a->fieldlist}However, the field group(s) listed below are still using some of these fields:{$a->fieldgrouplist}You must remove these fields from the field groups first before you may proceed.';
...
$string['deletinglayout'] = 'Deleting field layout "{$a}"';
...
$string['duplicateentryid'] = 'Duplicate Entryid {$a}';
...
$string['duplicatinglayout'] = 'Duplicating field layout "{$a}"';
$string['dynamiccheck'] = 'Dynamic check:';
$string['dynamiccheckauthor_desc'] = 'Granted to the user who created/owns the entry (e.g. no capability check).';
$string['dynamiccheckmentor_desc'] = 'Granted to users who are mentors for the team/group (e.g. no capability check).';
$string['editable'] = 'Editable';
$string['editableafterfinal'] = 'Editable after final submission';
$string['editableafterfinal_help'] = 'If enabled, fields rendered with this behaviour stay editable even after the entry has been set to "Final submission", for the users allowed by "Editable by". All other fields (and the status itself) remain locked. Users with the capability to manage entries can always edit final entries regardless of this setting.';
$string['editableby'] = 'Editable by';
$string['editableby_help'] = 'Users who have the corresponding Moodle capability (e.g. mod/datalynx:editprivilegestudent) granted for this activity can edit this field. These privilege levels map to Moodle capabilities that can be assigned to any role via the standard Moodle permissions interface.';
$string['editentryid'] = 'Edit Entryid {$a}';
$string['editing'] = 'Editing';
$string['editingbehavior'] = 'Editing field behavior "{$a}"';
$string['editingfieldgroup'] = 'Editing fieldgroup "{$a}"';
$string['editinglayout'] = 'Editing field layout "{$a}"';
...
$string['entriesconfirmreset'] = 'You are about to delete all data of {$a} entry(s). The entries are kept but reset to draft. Would you like to proceed?';
...
$string['entriesreset'] = '{$a} entry(s) reset';
...
$string['erroralphanumeric'] = 'The format name must contain only alphanumeric characters.';
$string['errorformatinuse'] = 'The field format cannot be deleted because it is currently in use in the following views: {$a}';
$string['errorformatnameexists'] = 'A field format with this name already exists in this Datalynx instance.';
...
$string['fieldformat_buttontext'] = 'Button label';
$string['fieldformat_cssclasses'] = 'CSS classes';
$string['fieldformat_dateformat'] = 'Date format';
$string['fieldformat_excerpt'] = 'Show as excerpt';
$string['fieldformat_mode'] = 'Output mode';
$string['fieldformat_showarrow'] = 'Show arrow';
...
$string['fieldformats'] = 'Field Formats';
...
$string['filtereditmodaltitle'] = 'Filter settings';
...
$string['geocoder'] = 'Geocoding service';
$string['geocoder_desc'] = 'Translates addresses into coordinates and back. Requests are made by this server, cached and rate limited.';
$string['geocoder_google'] = 'Google Geocoding API (requires an API key)';
$string['geocoder_nominatim'] = 'Nominatim (OpenStreetMap; search as you type is not permitted)';
$string['geocoder_none'] = 'None (address is entered as plain text)';
$string['geocoder_photon'] = 'Photon (recommended, supports search as you type)';
$string['geocodercachettl'] = 'Cache lifetime for address lookups';
$string['geocodercachettl_desc'] = 'How long a result may be reused. The Nominatim usage policy requires results to be cached, and a generous lifetime is what keeps this site inside the providers\' rate limits.';
$string['geocodercountries'] = 'Restrict to countries';
$string['geocodercountries_desc'] = 'Comma-separated ISO 3166-1 alpha-2 codes, for example <code>de,at,ch</code>. Leave empty to search worldwide. Individual location fields can override this.';
$string['geocoderkey'] = 'Geocoding API key';
$string['geocoderkey_desc'] = 'Required by the Google Geocoding API and by commercial providers. Never sent to the browser.';
$string['geocoderrate'] = 'Maximum requests per second';
$string['geocoderrate_desc'] = 'Applies to requests this server makes. Leave at 1 for the public OpenStreetMap services, whose policy allows no more. Raise it only for your own installation, or for a commercial plan that permits it.';
$string['geocoderurl'] = 'Geocoding service URL';
$string['geocoderurl_desc'] = 'Base URL of the service. Leave empty to use the selected service\'s public endpoint. Point this at your own installation to remove the rate limits and keep your users\' addresses on your own infrastructure.';
...
$string['greaterequal'] = 'greater or equal';
...
$string['index'] = 'Index';
$string['insertinputtag'] = 'Insert #input';
$string['insertvaluetag'] = 'Insert #value';
...
$string['jsincludesinvalid'] = 'The "Include external JS" field must contain one script URL or path per line, not JavaScript code. Lines containing spaces, braces ({ }) or semicolons look like source code and are not allowed here. Put your JavaScript into the "JS code" field instead.';
$string['jssaved'] = 'Javascript saved';
$string['jsupload'] = 'Upload javascript files';
$string['label'] = 'Label';
$string['layout'] = 'Layout';
$string['layoutadd'] = 'Add layout';
$string['layoutdeleted'] = 'Field layout deleted';
$string['layoutduplicated'] = 'Field layout duplicated';
$string['layouts'] = 'Layouts';
$string['layoutsaved'] = 'Field layout saved';
$string['lessequal'] = 'less or equal';
...
$string['lock'] = 'Lock';
$string['lockaftersave'] = 'Lock value after first save';
$string['lockaftersave_help'] = 'If enabled, the value of this field can no longer be changed once the entry has been saved with a value. The field becomes read-only for everyone. To change the value, the entry must be reset (which deletes all of the entry\'s data) using the ##reset## action.';
$string['manage'] = 'Manage';
$string['managemode'] = 'Manage mode';
$string['manager'] = 'Manager';
$string['map_contactemail'] = 'Contact address';
$string['map_contactemail_desc'] = 'Included in the User-Agent this site sends to map services. The OpenStreetMap usage policies require it so that an operator can reach you. Defaults to the site support email address.';
$string['map_defaultcentre'] = 'Default map centre';
$string['map_defaultcentre_desc'] = 'Where a map opens when no location has been chosen yet, as <code>latitude,longitude</code> — for example <code>48.2082,16.3738</code>. Leave empty to open on a world view.';
$string['map_defaultzoom'] = 'Default zoom level';
$string['map_defaultzoom_desc'] = 'Zoom level used together with the default centre. Ignored while no default centre is set.';
$string['map_maxzoom'] = 'Maximum zoom level';
$string['map_maxzoom_desc'] = 'Highest zoom level the tile source offers.';
$string['map_tileattribution'] = 'Basemap attribution';
$string['map_tileattribution_desc'] = 'Attribution shown in the corner of every map. Most tile operators, OpenStreetMap included, require it.';
$string['map_tilekey'] = 'Tile API key';
$string['map_tilekey_desc'] = 'Substituted into the <code>{key}</code> placeholder of the tile URL. Unlike the geocoding key, this one does reach the browser, because the browser loads the tiles.';
$string['map_tileurl'] = 'Basemap tile URL';
$string['map_tileurl_desc'] = 'Tile URL template, for example <code>https://tile.openstreetmap.org/{z}/{x}/{y}.png</code>. A <code>{key}</code> placeholder is replaced with the tile API key below. Tiles are the only map service the browser contacts directly, so the tile operator receives your users\' IP addresses.';
$string['mappingwarning'] = 'All old fields not mapped to a new field will be lost and all data in that field will be removed.';
$string['mapservices'] = 'Map services';
$string['mapservices_desc'] = 'Used by the Location field type. The basemap, the geocoding service and (later) the routing service are configured independently, because they are rarely the same provider. Address lookups always run through this site rather than from the browser: the providers require an identifying User-Agent that a browser is not allowed to send, they mandate server-side caching, and any API key has to stay on the server.';
$string['mapsharedwarning'] = 'At least one configured service is a free shared endpoint run for the community. These come with no availability guarantee, and their usage policies do not permit production traffic. Configure a self-hosted or commercial service before going live.';
$string['max'] = 'Maximum';
...
$string['newlayout'] = 'New field layout';
...
$string['picturelarge'] = 'Picture (large)';
...
$string['preset_alert_info'] = 'Info callout';
$string['preset_badge_primary'] = 'Badge';
$string['preset_blockquote'] = 'Blockquote';
$string['preset_border_start'] = 'Left accent border';
$string['preset_card_basic'] = 'Card';
$string['preset_card_shadow'] = 'Card with shadow';
$string['preset_chip_muted'] = 'Muted chip';
$string['preset_heading'] = 'Heading';
$string['preset_icon_value'] = 'Icon + value';
$string['preset_input_group_icon'] = 'Input with icon';
$string['preset_input_help'] = 'Input with help text';
$string['preset_input_labelled'] = 'Labelled input';
$string['preset_input_prefix_euro'] = 'Input with currency prefix';
$string['preset_lead'] = 'Lead text';
$string['preset_list_group'] = 'List group item';
$string['preset_pill_success'] = 'Success pill';
...
$string['presetfamily_cards'] = 'Cards & panels';
$string['presetfamily_edit'] = 'Edit-form styles';
$string['presetfamily_inline'] = 'Inline accents';
$string['presetfamily_typographic'] = 'Typographic';
...
$string['privacy:metadata:datalynx_entries:timesubmitted'] = 'Time when record was finally submitted';
$string['privacy:metadata:datalynx_entries:userid'] = 'User who created the record';
$string['privacy:metadata:datalynx_rule_matches'] = 'Records which pairs of entries a notification rule has already told the authors about, so that saving an entry again does not notify everyone a second time.';
$string['privacy:metadata:datalynx_rule_matches:entryhigh'] = 'The other entry of the pair';
...
$string['redirectandcontinue'] = 'Redirect and continue editing';
$string['redirectandcontinue_desc'] = 'Enable redirect and continue editing the entry';
$string['redirectandcontinue_help'] = 'If enabled, the user will be redirected to the target view in edit mode to continue editing the same entry.';
...
$string['resetentryid'] = 'Reset Entryid {$a}';
...
$string['router'] = 'Routing service';
$string['router_desc'] = 'Works out the driving distance and travel time along a journey. Requests are made by this server, cached and rate limited. Without a routing service, journeys show straight-line distance only.';
$string['router_google'] = 'Google Directions API (requires an API key)';
$string['router_none'] = 'None (no travel time, straight-line distance only)';
$string['router_osrm'] = 'OSRM (OpenStreetMap routing, no API key)';
$string['routerkey'] = 'Routing API key';
$string['routerkey_desc'] = 'Required by the Google Directions API and by commercial providers. Never sent to the browser.';
$string['routerurl'] = 'Routing service URL';
$string['routerurl_desc'] = 'Base URL of the service. Leave empty to use the selected service\'s public endpoint. The public OSRM demo server has no service level agreement and is for evaluation only - point this at your own installation before relying on it.';
...
$string['stagingtestacknowledged'] = 'I have tested this upgrade on a staging/test site';
$string['stagingtestacknowledged_desc'] = 'By checking this box you confirm that you have upgraded a staging or test copy of every affected Datalynx activity to this version and reviewed it before rolling the upgrade out here. Until this is checked, site administrators will see a warning instead of the Datalynx view.';
$string['stagingtesthdr'] = 'Staging test required';
$string['stagingtesthdr_desc'] = 'This release contains extensive changes to Datalynx (view rendering, filters, field formats and several database migrations). Please test it on a staging or test site before using it in production, then check the box below to confirm.';
$string['stagingtestwarning'] = 'This Datalynx release contains extensive changes. Please test the upgrade on a staging or test site before continuing to use it here, then confirm this in <a href="{$a}">the Datalynx plugin settings</a>.';
$string['statistics'] = 'Statistics';
$string['statisticsfor'] = 'Statistics for \'{$a}\'';
$string['status'] = 'Status';
$string['statusdraft'] = 'Draft';
$string['statusfinalsubmission'] = 'Final submission';
$string['statuslabeloff'] = 'Save application as draft';
$string['statuslabelon'] = 'Submit application bindingly';
...
$string['statustoggledesc'] = 'If you save the application as a draft, you can finalise and submit it later. If you submit the application bindingly, it can no longer be changed afterwards. Please review your submission beforehand.';
$string['student'] = 'Student';
$string['subfieldactions'] = 'Actions';
$string['subfieldaddbutton'] = 'Add subfield';
$string['subfieldaddmodaltitle'] = 'Add subfield';
$string['subfieldbehavior'] = 'Behavior (optional)';
$string['subfieldbehaviornone'] = '— default behavior —';
$string['subfieldeditmodaltitle'] = 'Edit subfield';
$string['subfieldfield'] = 'Field';
$string['subfieldformat'] = 'Format (optional)';
$string['subfieldformatnone'] = '— no format —';
$string['subfieldlayout'] = 'Layout (optional)';
$string['subfieldlayoutnone'] = '— default layout —';
$string['subfieldreloadformats'] = 'Reload formats';
...
$string['timesubmitted'] = 'Time of final submission';
...
$string['viewallowallfilters'] = 'Allow all filters';
$string['viewallowallfilters_desc'] = 'Users may switch to any visible filter.';
$string['viewallowallfilters_help'] = 'When enabled, users can switch to any visible filter (including ones created later), overriding the permitted filters list below. Improper use of this feature can display unintended information, be aware if using.';
...
$string['viewdefaultfilter'] = 'Default filter';
...
$string['viewpermittedfilters'] = 'Permitted filters';
$string['viewpermittedfilters_help'] = 'The additional filters a user may switch to in view mode, beside the default filter. Leave empty to lock the view to the default filter. Any filter not listed here is rejected and the default filter is applied instead. This setting is ignored while "Allow all filters" is enabled.';
$string['viewpermittedfiltersnodefault'] = 'Select a default filter when restricting the permitted filters.';
...
$string['visible8'] = 'Guest / Authenticated user';
$string['visibleallowedroles'] = 'Allowed roles in this course:';
$string['visiblecapability'] = 'Moodle Capability: {$a}';
$string['visiblenoroleswarning'] = 'Warning: No roles have this capability assigned in this course!';
$string['visibleto'] = 'Visible to';
$string['visibleto_help'] = 'Users who have the corresponding Moodle capability (e.g. mod/datalynx:viewprivilegestudent) granted for this activity can see this field. These privilege levels map to Moodle capabilities that can be assigned to any role via the standard Moodle permissions interface.';
