...
$string['upcomingreleaseannouncement'] = 'A major new version of Datalynx will be released on 1 October 2026 with extensive changes. Please <a href="{$a->downloadurl}" target="_blank" rel="noopener noreferrer">download and test it</a> on a staging or test site beforehand. Once noted, you can dismiss this notice in <a href="{$a->settingsurl}">the Datalynx plugin settings</a>.';
$string['upcomingreleasedismissed'] = "I've read this and no longer need the reminder";
$string['upcomingreleasedismissed_desc'] = 'Ticking this box only hides the reminder shown above and on Datalynx activity pages — it does not install anything, does not opt this site out of the new version, and does not change the 1 October 2026 release date. Leave it unticked until you have downloaded and tested the upcoming release; tick it once you have taken note so the reminder stops appearing.';
$string['upcomingreleasehdr'] = '⚠️ Upcoming major release — 1 October 2026';
$string['upcomingreleasehdr_desc'] = 'On 1 October 2026, a major new version of Datalynx will be released with extensive, breaking changes.<br /><br />This release will <strong>not</strong> install itself: nothing on this site will change automatically on that date. The new version will only become available in the plugin\'s source repository — whoever maintains this server has to fetch and install it manually, the same way any other update is applied.<br /><br />Because the changes are extensive, please <a href="{$a->downloadurl}" target="_blank" rel="noopener noreferrer">download and test the upcoming release</a> on a staging or test site before installing it here.<br /><br />Until the checkbox below is ticked, this same reminder appears on every Datalynx activity page, but only to site administrators — other users never see it, and it never blocks the page.';
