...
$string['dataform:editrestrictedfields'] = 'Edit restricted fields';
$string['dataform:viewdrafts'] = 'View drafts';
$string['dataform:viewprivilegeguest'] = 'Guest view access privilege';
$string['dataform:viewprivilegemanager'] = 'Manager view access privilege';
$string['dataform:viewprivilegestudent'] = 'Student view access privilege';
$string['dataform:viewprivilegeteacher'] = 'Teacher view access privilege';
$string['dataform:viewstatistics'] = 'View statistics';
