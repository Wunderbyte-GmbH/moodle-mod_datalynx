...
$string['onlyonchange_help'] = 'Felder aus den Auslösebedingungen oben auswählen. Die Benachrichtigung wird nur gesendet, wenn mindestens eines dieser Felder seinen Wert bei der auslösenden Aktualisierung tatsächlich geändert hat – nicht schon, wenn der aktuelle Wert zufällig der Bedingung entspricht. Hat keine Wirkung bei „Eintrag erstellt"-Ereignissen.';
