...
$string['onlyonchange_help'] = 'Select fields from the trigger conditions above. The notification will only be sent when at least one of these fields actually changed its value during the triggering update — not just when the current value happens to match the condition. Has no effect for "entry created" events.';
