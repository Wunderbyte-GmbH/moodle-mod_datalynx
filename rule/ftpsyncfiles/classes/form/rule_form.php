...
class rule_form extends base_rule_form {
    ...
    public function rule_definition() {
        ...
        $mform->addElement('header', 'settingshdr', get_string(
            'sftpsettings',
        ...
        $mform->addGroup(
            $grp,
            'sftpgrp',
            get_string('sftpsettings', 'datalynxrule_ftpsyncfiles'),
            $br,
            false
        );
        ...
        $mform->addElement(
            'autocomplete',
            'param8',
            get_string('teammemberfield', 'datalynxrule_ftpsyncfiles'),
            $fieldnames,
            $options
        );
        ...
        $mform->addElement(
            'autocomplete',
            'param9',
            get_string('manager', 'datalynxrule_ftpsyncfiles'),
            $choosuser,
            $options
        );
        ...
        $mform->addElement(
            'autocomplete',
            'param3',
            get_string('filefield', 'datalynxrule_ftpsyncfiles'),
            $fields,
            $options
        );
