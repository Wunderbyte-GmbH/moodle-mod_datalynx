...
/**
 * External function tests for get_csv_view_data.
 *
 * @package    mod_datalynx
 * @category   external
 * @copyright  2026 David Bogner
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @coversDefaultClass \mod_datalynx\external\get_csv_view_data
 * @runTestsInSeparateProcesses
 */
final class get_csv_view_data_test extends advanced_testcase {
    /**
     ...
     * @covers ::execute
     */
    public function test_execute_returns_csv_browse_payload(): void {
        $this->resetAfterTest();
        $this->setAdminUser();
