...
class restore_datalynx_activity_structure_step extends restore_activity_structure_step {
    /** @var int The group mode for this restore step. */
    ...
    /**
     * Process datalynx activity data during restore.
     *
     * @param array $data
     */
    ...
    /**
     * Process datalynx module data during restore.
     *
     * @param array $data
     */
    ...
    /**
     * Process datalynx field data during restore.
     *
     * @param array $data
     */
    ...
    /**
     * Process datalynx customfilter data during restore.
     *
     * @param array $data
     */
    ...
    /**
     * Process datalynx view data during restore.
     *
     * @param array $data
     */
    ...
    /**
     * Process datalynx rule data during restore.
     *
     * @param array $data
     */
    ...
    /**
     * Process datalynx entry data during restore.
     *
     * @param array $data
     */
    ...
    /**
     * Process datalynx content data during restore.
     *
     * @param array $data
     */
    ...
    /**
     * Process datalynx rating data during restore.
     *
     * @param array $data
     */
    ...
    /**
     * Process datalynx grade data during restore.
     *
     * @param array $data
     */
    ...
    /**
     * Process datalynx behavior data during restore.
     *
     * @param array $data
     */
    ...
    /**
     * Process datalynx renderer data during restore.
     *
     * @param array $data
     */
    ...
    protected function after_execute() {
        ...
        // Note: not quite item id; need to add folders there.
        $this->add_related_files('mod_datalynx', 'view', 'datalynx_view');

        // Preset related files (matching by itemname data_content) are not yet implemented.
        ...
        $results = $DB->get_records_sql_menu(
            $sql,
            ['type' => 'teammemberselect', 'dataid' => $datalynxnewid]
        );
        ...
        $results = $DB->get_records_sql_menu($sql, ['dataid' => $datalynxnewid]);
