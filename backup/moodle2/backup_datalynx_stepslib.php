...
class backup_datalynx_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $view = new backup_nested_element(
            'view',
            ['id'],
            ['type', 'name', 'description', 'visible', 'perpage', 'groupby', 'filter', 'permittedfilters',
        ...
        $customfilter->set_source_table('datalynx_customfilters', ['dataid' => backup::VAR_PARENTID]);
        $view->set_source_table('datalynx_views', ['dataid' => backup::VAR_PARENTID]);
