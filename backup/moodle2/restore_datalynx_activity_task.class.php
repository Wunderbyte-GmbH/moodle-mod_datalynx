...
class restore_datalynx_activity_task extends restore_activity_task {
    ...
    /**
     * Get the old module id for this restore task.
     *
     * @return int
     */
    ...
    /**
     * Set the owner id for this restore task.
     *
     * @param int $ownerid
     */
    ...
    /**
     * Get the owner id for this restore task.
     *
     * @return int
     */
    ...
    /**
     * Get the item name for comment mapping based on comment area.
     *
